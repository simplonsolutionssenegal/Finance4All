...
describe('PublicFooter', () => {
  ...
  it('should display the Finance4All brand section', () => {
    ...
    expect(screen.getByText('Votre partenaire pour une meilleure gestion financière.')).toBeInTheDocument();
  });
  ...
  it('should have proper copyright section styling', () => {
    render(<PublicFooter />);
    const copyrightSection = screen.getByText('© 2024 Finance4All. Tous droits réservés.').closest('div');
  ...
  it('should have accessibility-friendly structure', () => {
    ...
    const allLinks = [
      'Comparator', 'Formation', 'Conseil', // Services
      'FAQ', 'Contact', 'Aide' // Support
    ];
