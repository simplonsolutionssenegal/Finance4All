      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8'>
        <Card>
          ...
          <CardContent>
            ...
            <p className='text-xs text-muted-foreground'>0 en attente de validation</p>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader className='pb-2'>
            <CardTitle className='text-sm font-medium'>Produits financiers</CardTitle>
          </CardHeader>
          <CardContent>
            <div className='text-2xl font-bold'>0</div>
            <p className='text-xs text-muted-foreground'>0 produits actifs</p>
          </CardContent>
        </Card>
...
export default function AdminDashboardPage() {
  return (
    <div className="container mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card className="lg:col-span-2">
>>>>>>> ea3e2d2 (✨ FRONTEND : enregistrement d'une institution financiere)
          <CardHeader>
