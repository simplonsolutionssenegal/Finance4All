      ...
      <div className='hidden lg:flex lg:w-1/2 bg-primary-400 relative overflow-hidden'>
        ...
        <div className='relative z-10 flex flex-col justify-center px-12 text-white'>
          ...
          <p className='text-lg text-white/90 leading-relaxed'>
            Pas d&apos;inquiétude, ça arrive à tout le monde ! Indiquez simplement l&apos;adresse
            e-mail associée à votre compte, et nous vous enverrons un lien pour créer un nouveau mot
            de passe.
          </p>
        </div>
      </div>
